 ...
 * **citations**:  allows one to search for the citations of topics, authors, bibcode.  For example:
 
 * **references**: allows one to search for the references in topics, authors, bibcode
